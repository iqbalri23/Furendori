    ...
    <div class="dashboard-content">
      <div class="row">
        <div class="col-12">
          ...
          @endif
          <form action="{{ route('transaction.update', $item->id, $items->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="card">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <select name="shipping_status" class="form-control">
                        <option value="{{ $items->shipping_status }}">{{ $items->shipping_status }}</option>
                        <option value="" disabled>----------------</option>
                        <option value="PENDING">PENDING</option>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="resi" value="{{ $items->resi }}" required />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
