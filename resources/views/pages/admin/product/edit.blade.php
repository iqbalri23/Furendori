                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="price_discount" value="{{ $item->price_discount }}" required />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      <label>Deskripsi Produk</label>
                      <textarea type="number" id="editor" name="description"/>{!! $item->description !!}</textarea>
                    </div>
                  </div>
                </div> 
                <div class="row">
