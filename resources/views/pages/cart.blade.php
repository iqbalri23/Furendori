                ...
                <tbody>
                  ...
                  @foreach ($carts as $cart)
                   <tr>
                    ...
                    <td style="width: 35%;">
                      @if ($cart->product->price_discount >='1')
                      <div class="product-title">Rp.{{ number_format($cart->product->price_discount) }}</div>
                  ...
                  @if ($cart->product->price_discount >= '1')
                    @php $totalPrice += $cart->product->price_discount@endphp
                  @else
            ...
            <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select v-else class="form-contol"></select>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
